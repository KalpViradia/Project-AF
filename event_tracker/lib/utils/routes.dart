...
const String ROUTE_RESET_PASSWORD = '/reset-password';
const String ROUTE_HOME = '/home';
const String ROUTE_PROFILE = '/profile';
const String ROUTE_EDIT_PROFILE = '/edit-profile';
const String ROUTE_EVENT_DETAILS = '/event-details';
...
const String ROUTE_INVISIBLE_EVENTS = '/invisible-events';
const String ROUTE_ABOUT_US = '/about-us';
const String ROUTE_RECURRING_EVENTS = '/recurring-events';
...
class AppRoutes {
  static String get login => ROUTE_LOGIN;
  static String get signup => ROUTE_SIGNUP;
  static String get forgotPassword => ROUTE_FORGOT_PASSWORD;
  static String get resetPassword => ROUTE_RESET_PASSWORD;
  static String get home => ROUTE_HOME;
  static String get profile => ROUTE_PROFILE;
  static String get editProfile => ROUTE_EDIT_PROFILE;
  static String get eventDetails => ROUTE_EVENT_DETAILS;
  ...
  static String get invisibleEvents => ROUTE_INVISIBLE_EVENTS;
  static String get aboutUs => ROUTE_ABOUT_US;
  static String get recurringEvents => ROUTE_RECURRING_EVENTS;
