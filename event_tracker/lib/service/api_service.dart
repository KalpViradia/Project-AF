...
class ApiService {
  ...
  Future<dynamic> get(String endpoint, {bool useAuth = true}) async {
  ...
  Future<dynamic> post(String endpoint, {dynamic body, bool useAuth = true}) async {
    final headers = await _getHeaders(useAuth: useAuth);
  ...
  Future<dynamic> put(String endpoint, {dynamic body, bool useAuth = true}) async {
    final headers = await _getHeaders(useAuth: useAuth);
  ...
  Future<dynamic> delete(String endpoint, {bool useAuth = true}) async {
    final headers = await _getHeaders(useAuth: useAuth);
