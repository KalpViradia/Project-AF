...
class _ThemeCustomizationPageState extends State<ThemeCustomizationPage>
  ...
  void _applyPredefinedTheme(String theme) {
    ...
    Get.snackbar("Applied", "$theme theme applied", snackPosition: SnackPosition.BOTTOM);
  }
  ...
  void _applyCustomTheme() {
    ...
    Get.snackbar("Success", "Custom theme applied!", snackPosition: SnackPosition.BOTTOM);
  }
